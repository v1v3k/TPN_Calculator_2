  ...
  return (
    <div className={styles.center}>
      ...
      <div className={styles.row}>
        ...
        <div className={canakDisplay ? styles.inputSolutionHighlight : ''}>
          <div className={styles.input}>
            <span className={styles.inputLabel} >amount of Ca/Na/K to be added is: <AIIcon callback={onClickCANAAK} /></span>
            <input
              type="text"
              aria-label="chat input"
              required
      ...
      <div className={styles.row}>
        ...
        <div className={ivfDisplay ? styles.inputSolutionHighlight : ''}>
          <div className={styles.input}>
            <span className={styles.inputLabel} >NET IVF rate <AIIcon callback={onClickIVF} /> </span>
            <input
              type="text"
              aria-label="chat input"
              required
